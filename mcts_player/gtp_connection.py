...
class GtpConnection:
    def __init__(self, go_engine, board, debug_mode=False):
        ...
        # time limit used per move in seconds
        self.timelimit = 1
    ...
    def genmove_cmd(self, args):
        ...
        move = self.go_engine.get_move(self.board, color, self.timelimit)
    ...
    def policy_cmd(self, args):
        assert args[0] in ["random", "rule_based"]
    ...
    def policy_moves_cmd(self, args):
        ...
        if self.policy_type == "random":
            move_type, move_list = GoBoardUtil.random_policy_moves(self.board, color)
        elif self.policy_type == "rule_based":
            move_type, move_list = GoBoardUtil.rulebased_policy_moves(self.board, color)

        response = move_type + " "

        move_list = [format_point(point_to_coord(move, self.board.size)) for move in move_list]
        move_list.sort()
